...
- `HS Code` keeps the same release architecture as upstream `T3Code`, but publishes desktop artifacts under the DP branding.
...
- The published release title should read `HS Code vX.Y.Z`.
